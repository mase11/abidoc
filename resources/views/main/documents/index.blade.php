                    ...
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('documents.view_files', [$document->document_id], false) }}"  title="View Document Files" class="text-info u"><span class="fa fa-eye"></span></a>
                                    {!! Html::nbsp(3) !!}
                                    <a href="{{ route('documents.edit', [$document->document_id], false) }}" 
                                    title="Edit Document" class="text-info u"><span class="fa fa-pencil"></span></a>
                                    {!! Html::nbsp(3) !!}
                                    <a href="{{ route('documents.delete', [$document->document_id], false) }}" title="Delete Document" class="text-danger u"><span class="fa fa-trash"></span></a>
